...
CKPT="${1:-outputs/local_eval/conn_s450.pt}"
EB="${2:-5}"; EW="${3:-25}"
/home/chang/miniconda3/bin/python3 dpc/train_mixed.py --run_name p2_local_eval --wandb_mode offline \
  ...
  --vjepa_bf16 1 --eval_balance "$EB" --eval_windows "$EW" --eval_max_tokens 64
