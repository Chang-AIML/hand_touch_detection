...
CKPT="${1:-outputs/local_eval/conn_s750.pt}"; N="${2:-40}"
/home/chang/miniconda3/bin/python3 dpc/train_mixed.py --run_name p2_diag --wandb_mode offline \
  --init_fc "$CKPT" --fsdp 0 --eval_only 1 --diag_rollout "$N" --diag_G 8 --diag_temps "0.7,1.0,1.3" \
  --local_frames /home/chang/Dataset/Action_Spotting \
  --window_frames 600 --batch_size 1 --n_q 8 --stain 0 --use_text 0 --gate_lang 0 \
  --use_anchor 1 --anchor_stride 5 --anchor_max_side 252 --vjepa_bf16 1 \
  --eval_balance 60 --eval_balance_ood 60
