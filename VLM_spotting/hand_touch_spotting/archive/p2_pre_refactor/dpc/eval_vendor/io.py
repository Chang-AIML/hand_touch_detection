"""Vendored from hand_touch_detection/common/io.py (verbatim).

Small json / gz-json / pickle / text loaders. Only used by the eval_nms.py CLI
(`main`) to read saved prediction files and label splits. The scorer itself
(compute_mAPs / maps_quiet) does not need this module.
"""
import os
import re
import json
